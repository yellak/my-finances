 ...
 */
@PWA(name = "My Finances", shortName = "My Finances", enableInstallPrompt = false)
@Theme(themeFolder = "myfinances", variant = Lumo.DARK)
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "My Finances logo"));
        logoLayout.add(new H1("My Finances"));
